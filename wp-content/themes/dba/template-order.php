		...
		<div class="col-md-8 intro">
			...
			<div class="order-time">
				<div class="inner">
					...
					Pick Up At: <select name="product_option_1_1">
					<!-- <option value="10 15AM">10:15 AM</option> -->
					<option value="DID_NOT_SELECT">choose only if picking up after <?php echo date("g:i A", strtotime("-330 minutes"));//weird time here because of timezone offset?></option>
					...
					<input type="submit" name="submit" value="Select Pick Up Time" />
					</form>
